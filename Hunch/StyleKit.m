...
+ (void)initialize
{
    ...
    _hunchYellow = [UIColor colorWithRed: 0.97 green: 0.84 blue: 0.34 alpha: 1];
    _hunchRed = [UIColor colorWithRed: 0.88 green: 0.01 blue: 0.13 alpha: 1];
    _hunchLightBlue = [UIColor colorWithRed: 0.52 green: 0.63 blue: 0.67 alpha: 1];
    _hunchDarkViolet = [UIColor colorWithRed: 0.11 green: 0.06 blue: 0.11 alpha: 1];
    _hunchDarkIndigo = [UIColor colorWithRed: 0.14 green: 0.11 blue: 0.35 alpha: 1];
    _hunchOrange = [UIColor colorWithRed: 0.94 green: 0.5 blue: 0.1 alpha: 1];
    _hunchDeepPurple = [UIColor colorWithRed: 0.17 green: 0.04 blue: 0.21 alpha: 1];
    _hunchDeepBlue = [UIColor colorWithRed: 0.2 green: 0.22 blue: 0.24 alpha: 1];
    _hunchLightGreen = [UIColor colorWithRed: 0.14 green: 0.65 blue: 0.47 alpha: 1];
    _hunchBlue = [UIColor colorWithRed: 0.4 green: 0.59 blue: 0.72 alpha: 1];
    _hunchTurquoise = [UIColor colorWithRed: 0.13 green: 0.56 blue: 0.51 alpha: 1];
