...
#ifndef Hunch_Constants_h
#define Hunch_Constants_h

#define PARSE_APPLICATION_ID    @"mbXGjAAwjSlg18cBSvxaeSsChOrwvyiZRfNYZZK3"
#define PARSE_CLIENT_KEY        @"U0xuwgwfDYNFPAn9cdwcpgBv4KZBJlJUvs4p2Yac"
...
#define PARSE_USERNAME          @"Hunch Administrator"
#define PARSE_PASSWORD          @"hunch2015$"
